...
public class JEIItemBlacklist extends BlankModPlugin {
    ...
    public void register(IModRegistry registry) {
        ...
        blacklist.addItemToBlacklist(new ItemStack(AtumBlocks.LIMESTONE_FURNACE_LIT));
        blacklist.addItemToBlacklist(new ItemStack(AtumBlocks.LIMESTONE_DOUBLE_SLAB, 1, OreDictionary.WILDCARD_VALUE));
