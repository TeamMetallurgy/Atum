...
public class ItemNutsAgility extends ItemTexturedArmor {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
        ...
        player.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 240, 1, true, true)); //TODO Check showParticles boolean
        player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 240, 1, true, true)); //TODO Check showParticles boolean
