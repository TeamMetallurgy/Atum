...
public class EntityAtumFishHook extends EntityFishHook { //TODO
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public void onUpdate() {
        ...
        if (this.fishPosRotationIncrements > 0) {
            ...
            if (!this.worldObj.isRemote) {
                ItemStack stack = this.angler.getCurrentEquippedItem();

                if (this.angler.isDead || !this.angler.isEntityAlive() || stack == null || stack.getItem() != AtumItems.ANUKETS_BOUNTY || this.getDistanceSqToEntity(this.angler) > 1024.0D) {
                    this.setDead();
