...
public class RenderCustomArrow extends Render<CustomArrow> {
    ...
    @Override
    public void doRender(CustomArrow customArrow, double x, double y, double z, float entityYaw, float partialTicks) {
        this.bindEntityTexture(customArrow);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        GlStateManager.pushMatrix();
        GlStateManager.translate((float) x, (float) y, (float) z);
        GlStateManager.rotate(customArrow.prevRotationYaw + (customArrow.rotationYaw - customArrow.prevRotationYaw) * partialTicks - 90.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(customArrow.prevRotationPitch + (customArrow.rotationPitch - customArrow.prevRotationPitch) * partialTicks, 0.0F, 0.0F, 1.0F);
        ...
        float f9 = customArrow.arrowShake - partialTicks;
        ...
        super.doRender(customArrow, x, y, z, entityYaw, partialTicks);
    }

    @Override
    public ResourceLocation getEntityTexture(CustomArrow customArrow) {
        return new ResourceLocation((customArrow).getTexture());
    }
}